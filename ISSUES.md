...
**Status:** ✅ hermes-bridge OK — vòng lặp đầu-cuối chạy đúng: Hermes push `ISSUES.md` → Claude Code đọc thấy issue này pending → sửa dòng này → mở PR. Xem PR trong bình luận issue #6.
